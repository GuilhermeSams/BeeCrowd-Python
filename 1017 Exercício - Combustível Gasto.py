...
O segundo é a velocidade média durante a viagem (em Km / h).

Saída
Imprime quantos litros seriam necessários para fazer esta viagem, com três dígitos após a vírgula.'''
